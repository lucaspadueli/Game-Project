...
class Hero {
  constructor(){
    ...
    img.src = "https://www.avatarsinpixels..png";
  }
  moveUp() {
...
function darkCollision (hero, face){
  if (hero.x < face.x + 40 &&
    hero.x + 40 > face.x &&
    hero.y < face.y + 40 &&
    hero.y + 40 > face.y && !face.collisionDetected) {
     return true;
  face.y = 700;
...
function updateCanvas() {
 ...
 if(time > 5){
  ...
  function drawYouWon (score){
    ...
    ctx4.fillText(`Congratulation! You won! You scored ${score} points`, 100, 200);
  }
  if(time >= 60 && score >= 90){
    gameOver = true;
    canvas.style.display = "none";
